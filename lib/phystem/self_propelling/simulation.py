...
from phystem.self_propelling import creators 
import phystem.self_propelling.solvers as solvers 
from phystem.self_propelling.ui.graph import ParticlesGraph, Info, MeanVelGraph

from phystem.core.run_config import RunType, SolverType
from phystem.self_propelling.run_config import RealTimeCfg, SaveCfg
from phystem.self_propelling.configs import CreateCfg
from phystem.core.simulation import SimulationCore 
import phystem.core.creators as core_creator 
from phystem.self_propelling.ui.widget import WidgetManager
...
class Simulation(SimulationCore): 
    def get_creator(self):
        ...
        return creators.Particles(**self.create_cfg.get_pars(), rng_seed=self.rng_seed)
    ...
    def configure_ui(run_type: RunType):
        ...
        fig, axes, space_mngs = StandardSpace().run()
