...
class RealTimeCfg(run_config.RealTimeCfg):
    def __init__(self, dt: float, num_steps_frame: int, fps: int, num_col_windows: int=None, graph_cfg=None, 
        solver_type=SolverType.CPP, update_type=UpdateType.NORMAL, integration_type=IntegrationType.euler,
...
class CollectDataCfg(run_config.CollectDataCfg):
    def __init__(self, tf: float, dt: float, folder_path: str, num_col_windows: int=None, func_cfg=None, 
...
class SaveCfg(run_config.SaveCfg):
    def __init__(self, path: str, speed: float, fps: int, dt: float, num_col_windows:int=None, duration: float = None, 
        tf: float = None, graph_cfg=None, solver_type=SolverType.CPP, update_type=UpdateType.NORMAL,
